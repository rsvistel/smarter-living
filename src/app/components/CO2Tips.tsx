...
export default function CO2Tips({ transactions, exchangeRates }: CO2TipsProps) {
  ...
  console.log('Recent parking transactions (last 30 days):', recentParkingTransactions.length);
  ...
  // Only show tip if parking expenses > 15 CHF
  if (recentParkingExpenses <= 15) {
    return null;
  }
